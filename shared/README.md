...
- **Project summary**:
  [prompt/documentation/project-context.md](prompt/documentation/project-context.md)
- **Rules (conventions)**:
  [prompt/documentation/conventions-rules.md](prompt/documentation/conventions-rules.md)
- **Reference & tips**:
  [prompt/documentation/reference.md](prompt/documentation/reference.md),
  [prompt/documentation/tips-usage.md](prompt/documentation/tips-usage.md)
- **Handoff** (multi-session):
  [prompt/documentation/handoff.md](prompt/documentation/handoff.md)
- **Scope** (modules, API, infra):
  [prompt/documentation/scope.md](prompt/documentation/scope.md)
