...
the team agrees to adopt one, add it to [tips-usage.md](tips-usage.md) or to
[context.md](../store/context.md) as appropriate.
...
[tips-usage.md](tips-usage.md) or [context.md](../store/context.md) and, if
