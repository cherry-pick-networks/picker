...
| GET    | `/concepts/schemes/:id/tree`      | Return full concept hierarchy (ltree) for the scheme (e.g. picker-architecture).                                                                                |
| GET    | `/concepts/:id/dependencies`      | Return dependencies for the concept from concept_relation (e.g. depends-on).                                                                                     |
