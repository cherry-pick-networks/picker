...
- **By context**: Which § apply is in store.md "Rule index (context → sections)".
  Run `deno task rules:summary -- <task-type>` to get the list and one-line
  titles, or use the matching skill (e.g. feature-implementation,
