...
// relation_type = 'requires'. Run: deno task ontology-acyclic-check
// (Postgres required)
//
// See sharepoint/context/CONTEXT.md §6 Boundary: DAG checks strictly enforced for
...
const EDGES_QUERY = await loadSql(
  sqlDir,
  'edges_concept_relation.sql',
);
