//
// TS filename check: api/, api/test/, pipeline/test/ use camelCase or PascalCase base name
...
function reportAndExit(errors: [string, string][]): void {
  ...
  console.log(
    'TS filename check passed: api/, api/test/, pipeline/test/ follow naming rules.',
  );
}
