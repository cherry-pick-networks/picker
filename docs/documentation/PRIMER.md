...
- **Which § apply**: Run
  ...
  needed.
- **Checklists and tips**:
  `sharepoint/context/documentation/PRIMER.md` and the
...
RULESET.md §P and sharepoint/context/documentation/MANUAL.md (§P
pattern guide).
...
| **codebase-explorer**   | explore               | Codebase exploration, file/pattern/keyword search, structure discovery. Respect pathConfig and RULESET § structure. See `sharepoint/context/documentation/codebase-explorer-spec.md`. |
| **shell-runner**        | shell                 | Terminal commands (deno task, git, dev.sh). pre-push, rules:summary, clean-branches. Does not run destructive commands (RULESET.md §7). See `sharepoint/context/documentation/shell-runner-spec.md`. |
...
`sharepoint/context/documentation/compliance-verifier-work-instructions.md` if defined.
