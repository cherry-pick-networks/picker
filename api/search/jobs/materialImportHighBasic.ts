...
//
// Usage:
//   deno run -A api/search/materialImportHighBasic.ts
//   deno run -A api/search/materialImportHighBasic.ts --write-headwords
...
const sqlDir = new URL('../assets/', import.meta.url);
