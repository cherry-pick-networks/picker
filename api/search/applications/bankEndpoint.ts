...
} from '#api/search/services/bankGenerateDynamicService.ts';
import {
  createItem,
  ...
  ItemPatchSchema,
  updateItem,
} from '#api/search/services/bankService.ts';
import type { ItemPatch } from '#api/search/configurations/bankSchema.ts';
