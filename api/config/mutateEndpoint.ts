...
import { mutateScript } from './mutateService.ts';
import type { MutateResponse } from './mutateSchema.ts';
import { MutateRequestSchema } from './mutateSchema.ts';
...
export async function postScriptMutate(
  c: Context,
): Promise<Response> {
