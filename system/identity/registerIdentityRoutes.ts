...
import * as schedule from '#system/identity/schedule/endpoint.ts';
import * as achievement from '#system/identity/achievement/endpoint.ts';
import * as curriculumMapping from '#system/identity/curriculum/mappingEndpoint.ts';
