/**
 * POST /script/mutate: body validated with mutate.schema, then mutate.service.
 */

import type { Context } from "hono";
import { mutateScript } from "#system/script/mutate.service.ts";
import type { MutateResponse } from "#system/script/mutate.schema.ts";
import { MutateRequestSchema } from "#system/script/mutate.schema.ts";
