...
export type MutateOptions = z.infer<
  typeof MutateOptionsSchema
>;
...
export type MutateRequest = z.infer<
  typeof MutateRequestSchema
>;
...
export type MutateErrorResponse = z.infer<
  typeof MutateErrorResponseSchema
>;

export const MutateResponseSchema = z.discriminatedUnion(
  'ok',
  [
...
export type MutateResponse = z.infer<
  typeof MutateResponseSchema
>;
...
export type MutateOutput = z.infer<
  typeof MutateOutputSchema
>;
