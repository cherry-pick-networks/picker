...
export function setAllowlistLoader(
  fn: () => Promise<AllowlistData>,
): void {
  loader = fn;
  return;
}

async function ensureAllowlistLoaded(): Promise<
  AllowlistData
> {
  if (loader == null) {
...
export async function getAllowlistDataOrLoad(): Promise<
  AllowlistData
> {
