//
// Allowlist types only. Data: global_standards.toml; Governance provides it.
...
export type SubjectSchemeId =
  (typeof SUBJECT_SCHEMES)[number];
export type ContentTypeSchemeId =
  (typeof CONTENT_TYPE_SCHEMES)[number];
export type CognitiveLevelSchemeId =
  (typeof COGNITIVE_LEVEL_SCHEMES)[number];
export type ContextSchemeId =
  (typeof CONTEXT_SCHEMES)[number];
...
export type AllowlistData = Partial<
  Record<FacetName, Set<string>>
>;
