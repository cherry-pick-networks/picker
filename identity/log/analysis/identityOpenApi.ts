...
import type { ClusterRequest } from '#identity/config/diagnostic_settings/clusterSchema.ts';
...
import type { RootCauseRequest } from '#identity/config/diagnostic_settings/rootCauseSchema.ts';
