...
import * as identity from '#identity/actors/endpoint.ts';
import * as schedule from '#identity/schedule/endpoint.ts';
import * as achievement from '#identity/achievement/endpoint.ts';
import * as curriculumMapping from '#identity/curriculum/mappingEndpoint.ts';
import { registerIdentityOutlook } from './registerIdentityRoutesOutlook.ts';
