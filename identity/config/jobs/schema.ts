...
export type ScheduleItemPayload = z.infer<
  typeof ScheduleItemPayloadSchema
>;
...
export function parseScheduleItemId(
  ...
  | { actor_id: string; source_id: string; unit_id: string }
  | null {
...
export type ReviewRequest = z.infer<
...
export type ReviewWarning = z.infer<
  typeof ReviewWarningSchema
>;
