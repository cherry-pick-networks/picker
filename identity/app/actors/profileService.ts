...
import {
  ...
  ProfilePatchSchema,
  ProfileSchema,
} from '#identity/config/members/profileSchema.ts';

export type { Profile, Progress } from '#identity/config/members/profileSchema.ts';
export {
  ProfileCreateSchema,
  ProfilePatchSchema,
  ProfileSchema,
...
export {
  getProgress,
  updateProgress,
} from '#identity/app/schedule/progressService.ts';
...
export async function createProfile(
  ...
  await IdentityStores.profileStore.setProfile(
    profile.id,
    profile,
  );
  return profile;
...
async function saveProfileAndReturn(
  ...
  await IdentityStores.profileStore.setProfile(id, profile);
  return profile;
}
